...
savegscv = resRFC.to_csv('gscvRFCEVEN.csv', index=True)

bestRTC = RandomForestClassifier(n_estimators=40,max_depth=20)
...
bestknn = KNeighborsClassifier(n_neighbors=maxKNNat)
...
# print(resMLP)
savegscv = resMLP.to_csv('gsvMLPEVEN.csv', index=True)
